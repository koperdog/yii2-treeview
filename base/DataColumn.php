...
/**
 * DataColumn is the default column type for the [[TreeView]] widget.
 *
...
class DataColumn extends Column
{
    ...
    public function getDataCellValue($model, $key, $index)
    {
        if ($this->value !== null) {
            ...
            if(in_array($this->attribute, ['title', 'name'])){
                $depth = ($model->depth - $this->grid->depthRoot) >= 0 ? $model->depth - $this->grid->depthRoot : 0;
                return str_repeat($this->grid->depthPrefix, $depth).ArrayHelper::getValue($model, $this->attribute);
            }

...
/**
 * ActionColumn is a column for the [[TreeView]] widget that displays buttons for viewing and manipulating the items.
 *
 * To add an ActionColumn to the gridview, add it to the [[TreeView::columns|columns]] configuration as follows:
 *
 * ```php
 * 'columns' => [
 *     // ...
